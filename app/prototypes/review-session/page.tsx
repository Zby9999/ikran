...
import Intake from "./variant-intake";
...
export default function ReviewSessionPrototype() {
  ...
  return (
    <div className="prs-page">
      {/* Fake workbench backdrop: canvas with two prototype surfaces. */}
      <div className="prs-canvas" aria-hidden="true">
        <div className="prs-surface prs-surface-a">
          <div className="prs-surface-chrome" />
          <div className="prs-surface-shot" />
        </div>
        <div className="prs-surface prs-surface-b">
          <div className="prs-surface-chrome" />
          <div className="prs-surface-shot" />
        </div>
      </div>

      {/* Variant under test renders its own panel/sheet. Re-mounted on
          switch and replay so entrance motion re-runs. */}
