...
export type EventType =
  ...
  | "component_preview_exception_resolved"
  ...
  | "rule_update_review_created"
  | "rule_update_review_published"
  | "rule_update_revision_created"
  | "rule_update_decision_recorded"
  | "rule_update_apply_started"
  | "rule_update_applied"
  | "rule_update_apply_failed"
  | "designer_feedback_recorded"
  | "conversation_reconciliation_completed"
