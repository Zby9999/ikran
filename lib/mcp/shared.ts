...
export const IKRAN_MCP_INSTRUCTIONS =
  ...
  "FLOW CONTRACTS arrive on demand: claim_alignment_preparation returns the Alignment section_contract; claim_initial_design_system_preparation returns the complete frozen context and extraction source_contract. Read all context first; then record global/tokens/layout/interaction work units and one unit per component, followed by the cross-section audit. Follow each tool description.";
