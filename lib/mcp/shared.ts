...
export type RegisterIkranToolsDeps = {
  ...
  mcpEntryPath: string;
  studyMode?: boolean;
  /** Running plugin version used to validate a Study Kit manifest. */
