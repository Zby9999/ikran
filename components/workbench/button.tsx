...
const workbenchPressable =
  "transition-all duration-100 ease-out select-none outline-none focus-visible:outline-2 focus-visible:outline-[var(--blue)] focus-visible:outline-offset-2 disabled:cursor-not-allowed active:enabled:scale-[0.99] active:enabled:translate-y-px";
